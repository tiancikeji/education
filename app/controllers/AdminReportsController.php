...
class AdminReportsController extends BaseController {
	...
	{
		return View::make('admin.reports.create');
	}
	...
	public function store()
	{
		...
		return Redirect::route('admin.reports.create')
			->withInput()
	...
	public function show($id)
	{
		...
		return View::make('admin.reports.show', compact('report'));
	}
	...
	public function edit($id)
	{
		...
		return View::make('admin.reports.edit', compact('report'));
	}
