...
class CompositionsController extends BaseController {
	...
	public function index()
	{
		...
		return View::make('compositions.index', compact('compositions'));
	}
	...
	{
		return View::make('compositions.create');
	}
	...
	public function show($id)
	{
		...
		return View::make('compositions.show', compact('composition'));
	}
	...
	public function edit($id)
	{
		...
		return View::make('compositions.edit', compact('composition'));
	}
	...
	public function update($id)
	{
		...
		if ($validation->passes())
		{
			...
			return Redirect::route('compositions.show', $id);
		}

		return Redirect::route('compositions.edit', $id)
			->withInput()
			->withErrors($validation)
			->with('message', 'There were validation errors.');
	}
